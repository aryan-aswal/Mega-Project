...
import { deleteAccount } from '../../../../services/operations.js/PROFILE';
        ...
        <div>
            <div className='w-11/12 max-w-[350px] rounded-lg border border-richblack-400 bg-richblack-800 p-6 z-50 fixed left-[50%] top-[50%] -translate-x-1/2 -translate-y-1/2'>
                ...
                <div className='flex items-center gap-x-4'>
                    <button onClick={deleteMyAccount} className='flex items-center bg-yellow-50 cursor-pointer gap-x-2 rounded-md py-2 text-sm md:text-lg px-3 md:px-5 font-semibold text-richblack-900 undefined' >{button_1}</button>
